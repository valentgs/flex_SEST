...
def modulateload(T, p_i, ell_i, max_change, min_power, max_power, plot_initial=False, plot_final=False, print_initial=False, print_final=False):
    ...
    if(plot_final):
        ...
        # ax1.step(range(T), delta_ell_i.value + ell_i, label="Curve after optimization", marker='.', where='post', color=color, )
...
# modulateload(T, p_i, ell_i, max_change=10.0, min_power=0.0, max_power=10.0, plot_initial=False, plot_final=True, print_initial=True, print_final=True)